...
public class DemoActivity extends TabActivity {
	...
	private void initBadge() {
		...
		badge5.setText("37");
		badge5.setBackgroundResource(R.drawable.image1);
...
//						android.R.layout.simple_list_item_2, null);
	...
	private static String[] getStrings() {
		return new String[] { "Abbaye de Belloc", "Abbaye du Mont des Cats",
				...
				"Basket Cheese", "Bath Cheese", "Bavarian Bergkase",
				...
				"Bleu de Laqueuille", "Bleu de Septmoncel" };
	}
